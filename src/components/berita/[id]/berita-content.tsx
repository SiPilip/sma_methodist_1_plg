      ...
      <Container className="py-10">
        ...
        <div className="lg:grid lg:grid-cols-5 gap-10">
          <p className="lg:col-span-3">
            ...
            lectus viverra. Quis mi nulla aliquet scelerisque nulla urna turpis
            aenean. Habitasse fermentum faucibus diam vitae risus placerat nunc
            arcu. Nisi vulputate pretium tristique at non. Fermentum quam vitae
            ac ullamcorper molestie neque. Pharetra elementum auctor malesuada
            senectus ultricies. Donec interdum arcu in quis ut. Leo mauris sit
            quisque imperdiet duis vitae mi. Facilisi sit eget volutpat rutrum
            sed facilisis at purus. Sollicitudin praesent eu dignissim amet
            elementum mauris ultrices phasellus maecenas. At accumsan commodo
            porta senectus tellus at accumsan lorem. Quam vitae massa aliquet
            curabitur posuere leo nunc donec. Tellus lorem donec tellus interdum
            malesuada. Facilisis vulputate et vulputate metus. Semper diam et
            amet nibh. Velit ac porttitor eu aenean posuere est diam
            scelerisque. Quis non arcu lectus nisl nulla porttitor felis
            senectus. Risus lectus purus mattis ut enim risus egestas eu. Nec
            non nulla nunc morbi eu tristique. Ut facilisis quis duis massa duis
            molestie nisl. Quisque habitant sit elit tempor tempus in molestie
            dictum enim. Risus venenatis ornare ultrices ultrices consequat
            interdum nisi augue. Tortor suspendisse est feugiat suspendisse
            commodo nulla sed. Molestie tempus mi id sapien tempor faucibus
            vitae. Cum porttitor consectetur sit proin ut diam in venenatis
            ultrices. In nibh cras tempus sed metus ut purus pretium eleifend.
            Orci ultricies id neque nisl quis id vitae tincidunt. Mi vivamus a
            ...
            <div className="grid grid-cols-5 gap-3">
              ...
              <div className="col-span-3">
                ...
                <p className="line-clamp-4 text-xs">
                  ...
                  Vulputate erat sed quis congue hendrerit lectus orci molestie
                  ut. Purus in venenatis et eu egestas et et ante pellentesque.
